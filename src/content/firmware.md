...
It is mandatory to update the *bootloader* (https://github.com/particle-iot/core-firmware/tree/bootloader-patch-update) for proper functioning of this mode(valid only for Spark Core).
