...
**If (Device Name or ID:** This dropdown menu will be automatically populated with the names of Spark devices that are claimed to your account and are loaded with firmware.
